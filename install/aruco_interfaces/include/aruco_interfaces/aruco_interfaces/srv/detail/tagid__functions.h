...
#ifndef ARUCO_INTERFACES__SRV__DETAIL__TAGID__FUNCTIONS_H_
#define ARUCO_INTERFACES__SRV__DETAIL__TAGID__FUNCTIONS_H_
...
/// Create srv/Tagid message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aruco_interfaces__srv__Tagid_Request__init().
...
/// Destroy srv/Tagid message.
/**
 * It calls
 * aruco_interfaces__srv__Tagid_Request__fini()
...
/// Check for srv/Tagid message equality.
/**
...
/// Initialize array of srv/Tagid messages.
/**
...
/// Finalize array of srv/Tagid messages.
/**
 * It calls
 * aruco_interfaces__srv__Tagid_Request__fini()
...
/// Create array of srv/Tagid messages.
/**
 * It allocates the memory for the array and calls
 * aruco_interfaces__srv__Tagid_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Tagid messages.
/**
 * It calls
 * aruco_interfaces__srv__Tagid_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Tagid message array equality.
/**
...
/// Copy an array of srv/Tagid messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aruco_interfaces__srv__Tagid_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aruco_interfaces
...
/**
 * It calls
 * aruco_interfaces__srv__Tagid_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_aruco_interfaces
...
/**
 * It allocates the memory for the array and calls
 * aruco_interfaces__srv__Tagid_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aruco_interfaces
...
/**
 * It calls
 * aruco_interfaces__srv__Tagid_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ARUCO_INTERFACES__SRV__DETAIL__TAGID__FUNCTIONS_H_
