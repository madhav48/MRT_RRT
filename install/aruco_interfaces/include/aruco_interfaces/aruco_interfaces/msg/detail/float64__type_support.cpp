...
{
  new (message_memory) aruco_interfaces::msg::Float64(_init);
}

void Float64_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aruco_interfaces::msg::Float64 *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Float64_message_member_array[1] = {
  {
    ...
    offsetof(aruco_interfaces::msg::Float64, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Float64_message_members = {
  ...
  1,  // number of fields
  sizeof(aruco_interfaces::msg::Float64),
...
{
  return &::aruco_interfaces::msg::rosidl_typesupport_introspection_cpp::Float64_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aruco_interfaces, msg, Float64)() {
  return &::aruco_interfaces::msg::rosidl_typesupport_introspection_cpp::Float64_message_type_support_handle;
}
