...
bool aruco_interfaces__msg__image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aruco_interfaces.msg._image.Image", full_classname_dest, 33) == 0);
  }
  aruco_interfaces__msg__Image * ros_message = _ros_message;
  {  // image
...
PyObject * aruco_interfaces__msg__image__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aruco_interfaces.msg._image");
