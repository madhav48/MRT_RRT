...
#include "aruco_interfaces/srv/detail/rrtpath__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const std_msgs::msg::Int64MultiArray &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
// functions for std_msgs::msg::Int64MultiArray already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: coordinates
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Int64MultiArray(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = aruco_interfaces::srv::Rrtpath_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aruco_interfaces::srv::Rrtpath_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aruco_interfaces::srv::Rrtpath_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Rrtpath_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const aruco_interfaces::srv::Rrtpath_Request *>(
...
static size_t _Rrtpath_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Rrtpath_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Rrtpath_Request__callbacks = {
...
static rosidl_message_type_support_t _Rrtpath_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Rrtpath_Request__callbacks,
...
{
  return &aruco_interfaces::srv::typesupport_fastrtps_cpp::_Rrtpath_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aruco_interfaces::srv::Rrtpath_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aruco_interfaces::srv::Rrtpath_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<aruco_interfaces::srv::Rrtpath_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Rrtpath_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const aruco_interfaces::srv::Rrtpath_Response *>(
...
static size_t _Rrtpath_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Rrtpath_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Rrtpath_Response__callbacks = {
  "aruco_interfaces::srv",
  "Rrtpath_Response",
...
static rosidl_message_type_support_t _Rrtpath_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Rrtpath_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &aruco_interfaces::srv::typesupport_fastrtps_cpp::_Rrtpath_Response__handle;
}
...
static service_type_support_callbacks_t _Rrtpath__callbacks = {
  "aruco_interfaces::srv",
  "Rrtpath",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aruco_interfaces, srv, Rrtpath_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aruco_interfaces, srv, Rrtpath_Response)(),
...
static rosidl_service_type_support_t _Rrtpath__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Rrtpath__callbacks,
...
{
  return &aruco_interfaces::srv::typesupport_fastrtps_cpp::_Rrtpath__handle;
}
