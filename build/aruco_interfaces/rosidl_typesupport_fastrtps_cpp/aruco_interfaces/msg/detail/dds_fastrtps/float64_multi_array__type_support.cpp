...
#include "aruco_interfaces/msg/detail/float64_multi_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aruco_interfaces::msg::Float64MultiArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aruco_interfaces::msg::Float64MultiArray & ros_message)
{
  // Member: data
  {
    cdr >> ros_message.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aruco_interfaces::msg::Float64MultiArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aruco_interfaces::msg::Float64MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aruco_interfaces::msg::Float64MultiArray *>(
    untyped_ros_message);
...
{
  return &aruco_interfaces::msg::typesupport_fastrtps_cpp::_Float64MultiArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aruco_interfaces, msg, Float64MultiArray)() {
  return &aruco_interfaces::msg::typesupport_fastrtps_cpp::_Float64MultiArray__handle;
}
