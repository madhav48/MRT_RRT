...
#include "aruco_interfaces/msg/detail/float64__rosidl_typesupport_fastrtps_c.h"
...
using _Float64__ros_msg_type = aruco_interfaces__msg__Float64;
...
size_t get_serialized_size_aruco_interfaces__msg__Float64(
  const void * untyped_ros_message,
...
static uint32_t _Float64__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aruco_interfaces__msg__Float64(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aruco_interfaces
size_t max_serialized_size_aruco_interfaces__msg__Float64(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aruco_interfaces__msg__Float64;
    is_plain =
      (
...
static size_t _Float64__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aruco_interfaces__msg__Float64(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aruco_interfaces, msg, Float64)() {
