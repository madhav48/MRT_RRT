...
#include "aruco_interfaces/msg/detail/image__rosidl_typesupport_fastrtps_c.h"
...
using _Image__ros_msg_type = aruco_interfaces__msg__Image;
...
size_t get_serialized_size_aruco_interfaces__msg__Image(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Image__ros_msg_type * ros_message = static_cast<const _Image__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Image__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aruco_interfaces__msg__Image(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aruco_interfaces
size_t max_serialized_size_aruco_interfaces__msg__Image(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aruco_interfaces__msg__Image;
    is_plain =
      (
...
static size_t _Image__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aruco_interfaces__msg__Image(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aruco_interfaces, msg, Image)() {
